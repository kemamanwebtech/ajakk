...
public interface RpcAsync {
    ...
    void doLogin(String email, String passwd, AsyncCallback<LoginDTO> callback) throws IllegalArgumentException;
     ...
     * Register a user
     */
    void doSignup(String name, String email, String password, String phone, String location,
            AsyncCallback<String> asyncCallback);

    void createEvent(String name, String type, String datetime, String loc, String look_for, UserDTO user,
            AsyncCallback<String> asyncCallback);
    ...
    void saveUserProfile(UserDTO user, AsyncCallback<Integer> asyncCallback);
