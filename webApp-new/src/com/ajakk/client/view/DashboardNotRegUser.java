...
public class DashboardNotRegUser extends Composite {
    private static DashboardNotRegUserUiBinder uiBinder = GWT.create(DashboardNotRegUserUiBinder.class);

    interface DashboardNotRegUserUiBinder extends UiBinder<Widget, DashboardNotRegUser> {}

    private final RpcAsync     rpc           = GWT.create(Rpc.class);
    List<EventDTO>             eventList     = null;
    static EventDTO            selectedEvent = null;
    Date selectedDate = null;
    static DashboardNotRegUser instance = null;
    ...
    public static DashboardNotRegUser getInstance() {
        return instance;
    }
