...
public class Register extends Composite {
    ...
    void onSignUpClicked(ClickEvent e) {
        rpc.doSignup(txtName.getText(), txtEmail.getText(), txtPassword.getText(), txtPhone.getText(), txtLocation.getText(), new AsyncCallback<String>() {
            @Override
            ...
            public void onSuccess(String result) {
                if (result.equals("success")) {
                    ...
                    App.showMessage("", "Failed to contact server. Check your connectivity.", "", 500, 500);
                }
            }
        });
    }
